        ...
        <div className={classes.WorkContentItem}>
          ...
          <div className={classes.WorkContentText}>
            ...
            <p>
              ...
              Ознакомьтесь, пожалуйста, с <a href={Contract} className={classes.contractwork}>договором-офертой</a> на оказание услуг
        ...
        <div className={classes.WorkContentItem}>
          ...
          <div className={classes.WorkContentText}>
            ...
            <p>
              ...
              Oзнакомьтесь, пожалуйста, с <a href={Contract} className={classes.contractwork}>договором-офертой</a> на оказание услуг
